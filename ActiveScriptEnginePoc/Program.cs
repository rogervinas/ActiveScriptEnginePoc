...
namespace ActiveScriptEnginePoc
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            TestSubjectScript.TestSubject(properties1, "SubjectScript1.js", "Nuevo: Piso 100 m2 en Barcelona Capital, ¡date prisa!");
            ...
            TestSubjectScript.TestSubject(properties2, "SubjectScript1.js", "Nuevo: Parking 4 hab y 200 m2 en Su tia Maria y más novedades, ¡date prisa!");
